...
head(prosperLoan)
```
From the boxplot above, we saw that without the outliers, there is a trendence that higher scores in Prosper recieve a lower borrower rate. So I removed the data whose ProsperScore is 0 and checked the corretionship.
```{r}
