...
Since I have explored the univarite data, the next step is Bivariate section. With the selected variables, let's see the correlation matrix.
```{r echo=FALSE, Bivariate_Plots}
sub_vars <- c("BorrowerRate","Term",
                   "ProsperScore",
                   "IncomeRange",
                   "LoanOriginalAmount",
