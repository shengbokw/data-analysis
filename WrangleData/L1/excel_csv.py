...
def parse_file(datafile):
    ...
    for col in range(sheet.ncols):
        if col == 0:
            ...
            #cv = [sheet.cell_value(0, col),realmaxtime[0:3], maxtime]
            data[sheet.cell_value(0, col)] = {"maxval": maxval, "maxtime": realmaxtime}
...
def save_file(data, filename):
    with open(filename, 'w') as csvfile:
        ...
        for station in data:
            ...
            spamwriter.writerow([station, year, month, day, hour, data[station]["maxval"]])
